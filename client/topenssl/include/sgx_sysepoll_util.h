...
{
	int ret;
	ocall_epoll_ctl(&ret, __epfd, __op, __fd, __event);
	return ret;
}
...
{
	int ret;
	ocall_epoll_wait(&ret, __epfd, __events, __maxevents, __timeout);
	return ret;
}
...
{
	int ret;
	ocall_epoll_pwait(&ret, __epfd, __events, __maxevents, __timeout, __ss);
	return ret;
}
